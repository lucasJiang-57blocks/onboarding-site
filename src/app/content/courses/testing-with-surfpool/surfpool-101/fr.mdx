...
> L'exécution de `surfpool start` dans un espace de travail Anchor vous invite à utiliser l'Infrastructure as Code pour un déploiement automatique fluide de votre programme sur Surfnet.
