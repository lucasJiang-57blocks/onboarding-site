...
export const courses: CourseMetadata[] = withCourseNumber([
  {
    ...
    lessons: [
      ...
      { slug: "integrating-with-the-frontend" },
  ...
  },
  {
    ...
    lessons: [
      { slug: "introduction" },
      { slug: "blockchain-solana-basics" },
      { slug: "solana's-tokens-and-NFTs" },
      { slug: "solana-program-development" },
      { slug: "tradeable-token-program" },
      { slug: "solana-development-with-ai" },
      { slug: "anchor-basics-spl-token-2022" },
      { slug: "on-chain-analysis-arbitrage" },
